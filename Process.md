...
代码来源：
https://zenodo.org/records/11483329
...
UserWarning: Error checking compiler version for cl: [WinError 2] 系统找不到指定的文件。
请安装 Visual Studio Build Tools 并选择：
...
USPTO-50K：https://github.com/Hanjun-Dai/GLN（查找 schneider50k）

USPTO-FULL：https://github.com/Hanjun-Dai/GLN（查找 1976_Sep2016_USPTOgrants_smiles.rsmi 或 uspto_multi）
...
sh binarize.sh ./datasets/USPTO_50K/aug1 dict.txt
提示： Windows 默认不支持 .sh 脚本，建议使用 Git Bash 运行，或手动复制脚本内容在 PowerShell 中执行（主要包含 fairseq-preprocess 命令）。
...
Markdown 5211 bytes 467 words 272 lines Ln 269, Col 155HTML 3594 characters 392 words 134 paragraphs
